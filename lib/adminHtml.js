...
<table>
<thead><tr><th>Ricevuta</th><th>Data pub crawl</th><th>Pax</th><th>Nome</th><th>Email</th><th>Telefono</th><th>Lang</th></tr></thead>
<tbody>${rows || '<tr><td colspan=7>Nessuna prenotazione ancora.</td></tr>'}</tbody>
</table>
</div></body></html>`;
}
